...
// Values are based on Apple M1 microarchitecture estimates.
type TimingConfig struct {
	...
	// Default: 14 cycles (M1 Firestorm core branch mispredict penalty).
...
// DefaultTimingConfig returns a TimingConfig with M1-based default values.
